...
aur-warning = 
    AUR उपयोगकर्ता-प्रस्तुत पैकेज/स्क्रिप्ट का स्रोत है और हमेशा सुरक्षित नहीं होता।
    कृपया किसी भी AUR से डाउनलोड किए गए PKGBUILD की स्थापना से पहले समीक्षा अवश्य करें, क्योंकि कुछ PKGBUILD संभवतः हानिकारक हो सकते हैं। 
...
system-upgrade = सिस्टम अपग्रेड किया जा रहा है
removing-orphans = अनाथ पैकेज हटा रहे हैं
couldnt-find-packages = पैकेज नहीं मिल सके: {$packages} रिपॉज या AUR में
searching-repos = रिपॉज में खोज रहे हैं: {$query}
searching-aur = AUR में खोज रहे हैं: {$query}
...
# logging::output
repo-dependencies = रिपॉज निर्भरताएँ
aur-dependencies = AUR निर्भरताएँ
repo-make-dependencies = रिपॉज मेक निर्भरताएँ
aur-make-dependencies = AUR मेक निर्भरताएँ
repo-check-dependencies = रिपॉज चेक निर्भरताएँ
aur-check-dependencies = AUR चेक निर्भरताएँ
version = संस्करण
votes = वोट
...
do-you-want-to-install = क्या आप ये पैकेज और उनकी निर्भरताएँ इंस्टॉल करना चाहते हैं?
...
installing-repo-deps = रिपॉज निर्भरताएँ इंस्टॉल कर रहे हैं
...
remove-installed-make-deps = क्या आप स्थापित मेक निर्भरताएँ हटाना चाहते हैं?
done = हो गया!
...
pacnew-warning =
    ऐसा लगता है कि कम से कम एक प्रोग्राम जिसने आप इंस्टॉल या अपग्रेड किया है, ने .pacnew कॉन्फ़िग फ़ाइल इंस्टॉल की है।
